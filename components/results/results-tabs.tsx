...
export function ResultsTabs({
  ...
  return (
    <div className="flex space-x-1 shrink-0 px-2 relative top-0.5">
      <button
        onClick={() => onTabChange("analysis")}
        className={`py-3 px-5 rounded-t-lg font-bold text-xl whitespace-nowrap transition-all cursor-pointer border-t-2 border-x-2 relative ${
          activeTab === "analysis"
            ? "bg-white text-teal-700 border-gray-200 border-b-0 pb-3.5"
