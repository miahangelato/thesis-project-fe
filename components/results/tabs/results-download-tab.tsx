      ...
      <div className="flex flex-col flex-1 min-h-0 h-full">
        <div className="flex items-start justify-between gap-4 mb-4 p-6 pb-0">
          <h2 className="text-4xl font-bold text-teal-900 flex items-center">
            <QrCode className="w-10 h-10 mr-3 text-teal-600" />
            Scan to Download
          </h2>
        </div>

        <div className="flex-1 flex items-center justify-center p-6">
          <div className="grid grid-cols-2 gap-2 items-center max-w-6xl w-full">
            <div className="flex flex-col items-center">
              ...
              <p className="mt-10 text-gray-500 font-medium flex items-center text-xl">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-2xl p-6">
                <p className="text-2xl text-gray-600 flex items-start">
                  <Info className="w-6 h-6 mr-3 mt-1.5 shrink-0 text-gray-400" />
                  <span>
