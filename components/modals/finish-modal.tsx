...
export const FinishConfirmationModal = ({
  ...
  return (
    <ModalShell
      ...
      panelClassName="max-w-xl border-2 border-teal-100"
      showTopBar
    >
      <div className="p-10 flex flex-col items-center text-center">
        ...
        <p className="text-2xl text-slate-600 mb-10 leading-relaxed max-w-lg mx-auto font-medium">
          Please confirm you have scanned and reviewed all 10 fingerprints. You can still
          review them if needed.
        </p>

        <ul className="mb-10 space-y-4 text-2xl text-slate-700 text-left bg-linear-to-br from-teal-50 to-cyan-50 p-6 rounded-2xl w-full border border-teal-100 font-medium">
          <li className="flex items-center gap-4">
            <CheckCircle className="w-8 h-8 text-[#00c2cb] shrink-0" strokeWidth={2.5} />
        ...
        <div className="flex flex-row gap-4 w-full">
          ...
          <Button
            ...
            onClick={onConfirm}
            disabled={loading}
            className="flex-1 h-20 text-2xl font-bold rounded-2xl bg-[#00c2cb] hover:bg-[#00adb5] text-white shadow-lg shadow-teal-100/50 transition-all transform hover:scale-[1.02] active:scale-[0.98] cursor-pointer"
          >
            Yes, Finish!
          </Button>
        </div>
  ...
  return (
    <div className="fixed inset-0 z-60 bg-white/90 backdrop-blur-sm flex items-center justify-center transition-all duration-500">
      <div className="text-center px-8 w-full max-w-3xl">
        <div className="relative mb-12 flex items-center justify-center">
          {isError ? (
            <div className="flex flex-col items-center gap-4">
              <div className="w-32 h-32 rounded-full bg-red-50 border border-red-100 flex items-center justify-center">
        ...
        <p className="text-slate-700 mb-10 text-2xl">
          {isError
        ...
        {!isError && (
          <div className="space-y-4 text-left">
            <div
              className="flex items-center gap-4 bg-teal-50 border border-teal-100 rounded-xl p-6 backdrop-blur-sm animate-in slide-in-from-bottom-4 fade-in duration-700 fill-mode-forwards"
              style={{ animationDelay: "100ms" }}
            >
              <div className="w-12 h-12 rounded-full bg-teal-100/60 flex items-center justify-center shrink-0">
              ...
              <div>
                ...
                <p className="text-xl text-slate-600">Securely transmitting data</p>
              </div>
            </div>
            ...
            >
              ...
              <div>
                <p className="text-2xl text-slate-900 font-medium">Running AI analysis</p>
                <p className="text-xl text-slate-600">Processing patterns & minutiae</p>
              </div>
            </div>
            ...
            >
              ...
              <div>
                <p className="text-2xl text-slate-900 font-medium">Generating results</p>
                <p className="text-xl text-slate-600">Finalizing your report</p>
              </div>
            </div>
          </div>
        )}
