...
export function StaticInfoPanel() {
  return (
    <div className="bg-linear-to-br from-[#e4f7f8] to-white rounded-2xl p-6 border-2 border-[#00c2cb]/20 shadow-sm h-fit">
      <h3 className="text-4xl font-bold text-slate-800 mb-4">What happens next</h3>

      <div className="space-y-5">
        <div className="flex items-center gap-4">
          <div className="w-10 h-10 rounded-full bg-[#00c2cb]/10 flex items-center justify-center shrink-0">
            <Fingerprint className="h-8 w-8 text-[#00c2cb]" />
          </div>
        ...
        <div className="flex items-center gap-4">
          <div className="w-10 h-10 rounded-full bg-[#00c2cb]/10 flex items-center justify-center shrink-0">
            <Brain className="h-8 w-8 text-[#00c2cb]" />
          </div>
          <p className="text-2xl font-medium text-slate-700 whitespace-nowrap">
        ...
        <div className="flex items-center gap-4">
          <div className="w-10 h-10 rounded-full bg-[#00c2cb]/10 flex items-center justify-center shrink-0">
            <Eye className="h-8 w-8 text-[#00c2cb]" />
          </div>
          <p className="text-2xl font-medium text-slate-700 whitespace-nowrap">
        ...
        <div className="flex items-center gap-4">
          <div className="w-10 h-10 rounded-full bg-[#00c2cb]/10 flex items-center justify-center shrink-0">
            <Shield className="h-8 w-8 text-[#00c2cb]" />
          </div>
          <p className="text-2xl font-medium text-slate-700 whitespace-nowrap">
