        ...
        <main className="flex-1 flex flex-col overflow-hidden select-none">
          <div className="flex flex-col px-28 py-6 overflow-hidden">
            ...
            <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
              ...
              {/* Pagination moved here so it's between Back and filters */}
              {totalPages > 1 && (
              ...
              <div className="flex flex-wrap items-center justify-end gap-3">
                <div className="flex items-center gap-2">
                  <span className="text-2xl font-semibold text-gray-700">Type:</span>
                  <select
                    value={filter}
                    onChange={(e) => {
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-4">
                            <div className="w-12 h-12 bg-teal-50 rounded-2xl flex items-center justify-center shrink-0 border border-teal-100">
                              <Hospital className="text-3xl text-teal-600" />
                            </div>
                            <h4 className="font-bold text-5xl text-gray-900 leading-tight">
                              {facility.name}
                            </h4>
                          </div>
